  ...
  return (
    <section className='py-[80px]'>
      <div className="containers">
        <Heading classList='!text-[28px] lg:!text-[38px]' tag='h2'>Trending Collection</Heading>
        <Text classList='!text-[16px] lg:!text-[22px] !mb-[40px] lg:!mb-[60px]'>Checkout our weekly updated trending collection.</Text>
